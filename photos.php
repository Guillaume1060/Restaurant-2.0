            ...
            <div class="col-lg-8">
              <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  ...
                  <!-- /// on va créer une div ici pour almimenter le carousel // faut il modifier la page en PHP ou récupérer une variable-->
<?php
...
?>
            ...
            <div class="col">
                <q class="fs-3 mt-5 text-center d-block w-75 mx-auto">L'homme ne pourra jamais cesser de rêver. Le rêve est la nourriture de l'âme comme les aliments sont la nourriture du corps.</q>
